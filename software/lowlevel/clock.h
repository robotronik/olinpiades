...
const int RCC_CLOCK_FREQ_HZ = 64000000;

// Interruptions = 10kHz = 100us (beaucoup ?)
const int SYSTICK_FREQ_HZ = 100000;
const int SYSTICK_PERIOD = RCC_CLOCK_FREQ_HZ / SYSTICK_FREQ_HZ;

const int MICROS_SYSTICK_RATIO = 1000000 / SYSTICK_FREQ_HZ;
...
const int PWM_GRANUL_FREQ_HZ = 100000;
const int PWM_GRANUL_PERIOD = RCC_CLOCK_FREQ_HZ / PWM_GRANUL_FREQ_HZ;
//static_assert(PWM_GRANUL_PERIOD == 640);
// Fréquence des PWM = 50Hz = 20ms
const int PWM_FREQ_HZ = 50;
const int PWM_PERIOD = PWM_GRANUL_FREQ_HZ / PWM_FREQ_HZ;
...
// 64MHz/1280 = 50kHz
const int HALL_PRESCALER = 1280;
const int HALL_COUNTER_PERIOD = (1<<16)-1;
// APB1 and APB2 timer frequency are considered to be the same
const int APBx_TIMER_FREQ_HZ = RCC_CLOCK_FREQ_HZ;
const int HALL_SAMPLE_FREQ_HZ = APBx_TIMER_FREQ_HZ / HALL_PRESCALER;
